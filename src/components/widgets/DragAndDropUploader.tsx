      ...
      {step === 2 && (
        <Box maxW="500px" mx="auto" p="2" as="form" onSubmit={handleSubmit(onSubmit)}>
          ...
          <Stack direction="row" align="center">
            ...
            <Text fontWeight="600">Add details about your special art NFT</Text>
          </Stack>
          <Stack w="100%" direction={{ base: "column", lg: "row" }} mt="2" spacing="4">
            ...
            <Stack w="100%">
              <FormControl id="name">
                ...
                <Input {...register("name", { required: true })} placeholder="The anarchy in my mind" />
              </FormControl>
              <FormControl id="username">
                <FormLabel>Artist Name</FormLabel>
                <Input {...register("username", { required: true })} placeholder="John Doe" />
              </FormControl>
              <FormControl id="tags">
                <FormLabel>Tags</FormLabel>
                <Input {...register("tags")} placeholder="abstract, nature, ...etc" />
              </FormControl>
              <FormControl id="description" size="sm">
                <FormLabel>About the Artist</FormLabel>
                <Textarea {...register("description")} rows={2} fontSize="sm" placeholder="The artist was diagnosed as autistic at the age of 9... etc" />
              </FormControl>
              <FormControl id="quote" size="sm">
                <FormLabel>Artist's Quote about the Artwork</FormLabel>
                <Textarea {...register("quote")} rows={2} fontSize="sm" placeholder="My work is a reflection of the constant war of chaos raging in my mind..." />
              </FormControl>
              {/* Bottom bar */}
              <Stack direction="row" align="center">
